...
(Get-Content "Cargo.toml") -replace "eframe_paint", $crate | Set-Content "Cargo.toml"
(Get-Content "src\main.rs") -replace "eframe_paint", $crate | Set-Content "src\main.rs"
(Get-Content "index.html") -replace "eframe template", $crate -replace "eframe_paint", $crate | Set-Content "index.html"
(Get-Content "assets\sw.js") -replace "eframe_paint", $crate | Set-Content "assets\sw.js"
