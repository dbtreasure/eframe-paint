...
pub mod factory {
    ...
    /// * `points` - Vector of points defining the stroke path
    /// * `thickness` - Stroke line thickness
    /// * `color` - Stroke color
    ///
    /// # Returns
    /// A new stroke element
    ...
    /// # Returns
    /// A new image element
    pub fn create_image(id: usize, data: Vec<u8>, size: Vec2, position: Pos2) -> ElementType {
    ...
    */
    ...
    // Legacy compatibility functions have been removed
}
