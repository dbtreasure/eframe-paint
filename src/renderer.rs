...
use crate::texture_manager::{TextureManager, TextureGenerationError};
...
impl Renderer {
    ...
    pub fn draw_element(&mut self, ctx: &egui::Context, painter: &egui::Painter, element: &mut dyn Element) {
    ...
    pub fn render(
        ...
        for element_id in &selected_ids {
            ...
            if any_resize_active && self.is_handle_active(*element_id) {
                ...
                self.draw_resize_preview(&ctx, ui.painter(), editor_model, *element_id, preview_rect);
                drawn_element_ids.insert(*element_id);
            } 
            ...
            match element {
                ...
                ElementType::Image(_) => {
                    ...
                    painter.rect_stroke(
                        preview_rect,
                        0.0,
                        egui::Stroke::new(2.0, egui::Color32::from_rgba_premultiplied(100, 100, 255, 200)),
                    );
                },
            }
        }
    ...
    pub fn process_resize_interactions_for_ids(
        ...
        let selected_elements: Vec<&ElementType> = selected_ids.iter()
    ...
    pub fn draw_debug_overlay(&self, ui: &mut egui::Ui) {
        ...
        ui.label(format!("Texture cache size: {}", self.texture_manager.cache_size()));
